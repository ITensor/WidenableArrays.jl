...
- [ ] My code follows the style guidelines of this project. Please run `using JuliaFormatter; format(".")` in the base directory of the repository (`~/.julia/dev/PromotableStorageArrays`) to format your code according to our style guidelines.
